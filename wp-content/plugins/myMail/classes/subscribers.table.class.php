...
class MyMail_Subscribers_Table extends WP_List_Table {
	...
	public function no_items() {
		...
		switch ( $status ) {
		case '0': //pending
			esc_html_e( 'No pending subscribers found', 'mymail' );
			break;
		case '2': //unsubscribed
			esc_html_e( 'No unsubscribed subscribers found', 'mymail' );
			break;
		case '3': //hardbounced
			esc_html_e( 'No hardbounced subscribers found', 'mymail' );
			break;
		case '4': //error
			esc_html_e( 'No subscriber with delivery errors found', 'mymail' );
			break;
		default:
			esc_html_e( 'No subscribers found', 'mymail' );

...
if ( $phpmailerversion = mymail_option( 'php_mailer' ) ):
	...
	if ( !class_exists( 'PHPMailer_mymail' ) ) {
		require_once MYMAIL_DIR . 'classes/libs/phpmailer/class.phpmailer.php';
	}

if ( !class_exists( 'SMTP_mymail' ) ) {
	require_once MYMAIL_DIR . 'classes/libs/phpmailer/class.smtp.php';
}
...
class mymail_mail_helper extends _mymail_mail_helper {
	...
	public function __construct( $exceptions = false ) {
		...
		$this->SMTPOptions = apply_filters( 'mymail_smtp_options', mymail_option( 'allow_self_signed' )
			? array(
				'ssl' => array (
					'verify_peer' => false,

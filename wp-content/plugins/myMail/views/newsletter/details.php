...
<table class="form-table">
		...
		<tr valign="top">
			<th scope="row"><?php esc_html_e( 'Subject', 'mymail' )?></th>
		...
		<tr valign="top">
			<th scope="row"><?php esc_html_e( 'Preheader', 'mymail' )?></th>
		...
		<tr valign="top">
			<th scope="row"><?php esc_html_e( 'From Name', 'mymail' )?> <a class="default-value mymail-icon" data-for="mymail_from-name" data-value="<?php echo esc_attr( mymail_option( 'from_name' ) ) ?>" title="<?php esc_html_e( 'restore default', 'mymail' )?>"></a></th>
		...
		<tr valign="top">
			<th scope="row"><?php esc_html_e( 'From Email', 'mymail' )?> <a class="default-value mymail-icon" data-for="mymail_from" data-value="<?php echo esc_attr( mymail_option( 'from' ) ) ?>" title="<?php esc_html_e( 'restore default', 'mymail' )?>"></a></th>
		...
		<tr valign="top">
			<th scope="row"><?php esc_html_e( 'Reply-to Email', 'mymail' )?> <a class="default-value mymail-icon" data-for="mymail_reply_to" data-value="<?php echo esc_attr( mymail_option( 'reply_to' ) ) ?>" title="<?php esc_html_e( 'restore default', 'mymail' )?>"></a></th>
...
<table>
	<tr><th width="16.666%"><?php esc_html_e( 'Subject', 'mymail' )?></th><td><strong><?php echo $this->post_data['subject']; ?></strong></td></tr>
<?php if ( $post->post_status != 'autoresponder' ): ?>
	<tr><th><?php esc_html_e( 'Date', 'mymail' )?></th><td><?php echo date( $timeformat, $this->post_data['timestamp'] + $timeoffset );
...
<?php endif;?>
	<tr><th><?php esc_html_e( 'Preheader', 'mymail' )?></th><td><?php echo $this->post_data['preheader'] ? $this->post_data['preheader'] : '<span class="description">' . __( 'no preheader', 'mymail' ) . '</span>' ?></td></tr>
</table>
...
<table>
	...
	<tr><th><?php ( $post->post_status == 'autoresponder' ) ? esc_html_e( 'Total Sent', 'mymail' ) : esc_html_e( 'Total Recipients', 'mymail' )?></th><td class="nopadding"> <span class="big hb-totals"><?php echo number_format_i18n( $totals ); ?></span>
...
?>
	<?php if ( !empty( $sent ) ): ?>
		<a href="#" id="show_recipients" class="alignright mymail-icon showdetails"><?php esc_html_e( 'details', 'mymail' )?></a>
		<span class="spinner" id="recipients-ajax-loading"></span><div class="ajax-list" id="recipients-list"></div>
	<?php endif;?>
	</td></tr>
<?php if ( !empty( $errors ) ): ?>
	<tr><th><?php esc_html_e( 'Total Errors', 'mymail' )?></th><td class="nopadding"> <span class="big hb-errors"><?php echo number_format_i18n( $errors ) ?></span>
	<?php if ( !empty( $errors ) ): ?>
		<a href="#" id="show_errors" class="alignright mymail-icon showdetails"><?php esc_html_e( 'details', 'mymail' )?></a>
		<span class="spinner" id="error-ajax-loading"></span><div class="ajax-list" id="error-list"></div>
	<?php endif;?>
	</td></tr>
<?php endif;?>
	<tr><th><?php esc_html_e( 'Total Clicks', 'mymail' )?></th><td class="nopadding"> <span class="big hb-clicks_total"><?php echo number_format_i18n( $clicks_total ) ?></span>
	<?php if ( !empty( $clicks_total ) ): ?>
		<a href="#" id="show_clicks" class="alignright mymail-icon showdetails"><?php esc_html_e( 'details', 'mymail' )?></a>
...
?>
		<tr class="environment"><th><?php esc_html_e( 'Environment', 'mymail' )?></th><td class="nopadding">
			...
			<?php }?>
			<a href="#" id="show_environment" class="alignright mymail-icon showdetails"><?php esc_html_e( 'details', 'mymail' )?></a>
...
?>
		<tr class="geolocation"><th><?php esc_html_e( 'Geo Location', 'mymail' )?></th><td class="nopadding">
...
?>
	...
	if ( ++$i >= 5 ) {
		break;
			...
			<a href="#" id="show_geolocation" class="alignright mymail-icon showdetails"><?php esc_html_e( 'details', 'mymail' )?></a>
